...
function buildDescriptors(): ProviderDescriptor[] {
  ...
  return [
    ...
    },
    {
      ...
      defaultModel: envText(process.env.OPENAI_MODEL, "gpt-5.4-mini"),
    ...
    },
    {
      ...
      label: "Gemini",
      kind: "openai-compatible",
      baseUrl: envText(process.env.GEMINI_BASE_URL, gatewayBase),
      defaultModel: envText(process.env.GEMINI_MODEL, "gemini-3-flash-preview"),
      apiKeyEnv: process.env.GEMINI_API_KEY ? "GEMINI_API_KEY" : "LLM_GATEWAY_API_KEY",
      configured: Boolean(process.env.GEMINI_API_KEY || gatewayKey),
    },
    {
      id: "grok",
      label: "Grok",
      kind: "openai-compatible",
      baseUrl: envText(process.env.GROK_BASE_URL, gatewayBase),
      defaultModel: envText(process.env.GROK_MODEL, "grok-4-fast"),
      apiKeyEnv: process.env.GROK_API_KEY ? "GROK_API_KEY" : "LLM_GATEWAY_API_KEY",
      configured: Boolean(process.env.GROK_API_KEY || gatewayKey),
    },
    {
      id: "qwen",
      label: "Qwen",
      kind: "openai-compatible",
      baseUrl: envText(process.env.QWEN_BASE_URL, gatewayBase),
      defaultModel: envText(process.env.QWEN_MODEL, "qwen3.5-flash"),
      apiKeyEnv: process.env.QWEN_API_KEY ? "QWEN_API_KEY" : "LLM_GATEWAY_API_KEY",
      configured: Boolean(process.env.QWEN_API_KEY || gatewayKey),
    },
  ];
}
